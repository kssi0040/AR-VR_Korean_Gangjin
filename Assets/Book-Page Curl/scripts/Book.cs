...
public class Book : MonoBehaviour {
    ...
    void Start()
    {
        ...
        //canvas = GameObject.Find("Canvas_book").transform.GetComponent<Canvas>();
        canvas = GameObject.Find("PhotoCanvas").transform.GetComponent<Canvas>();        
        //============
        ...
        // 추가됨...        
        this.gameObject.GetComponent<RectTransform>().localScale = new Vector3(4f, 4f, 1f);
    ...
    void Flip()
    {
        ...
        if(bookPages.Length == currentPage)
        {
            Debug.Log("last page");
            forwardButton.SetActive(true);
            //forwardButton.gameObject.transform.SetParent(this.gameObject.transform);
